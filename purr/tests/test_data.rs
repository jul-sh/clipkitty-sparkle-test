//! Test data constants for debugging specific issues

/// Long content for testing fullContentHighlights computation
/// Issue: Highlight ranges computed incorrectly for long text (e.g., "iles" highlighted instead of search term)
pub const LONG_TEST_CONTENT: &str = r#"
---
name: macos-cleaner
